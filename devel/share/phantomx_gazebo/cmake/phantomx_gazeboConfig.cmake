...
if("TRUE" STREQUAL "TRUE")
  set(phantomx_gazebo_SOURCE_PREFIX /home/sim/phantom_x/src/phantomx_gazebo)
  set(phantomx_gazebo_DEVEL_PREFIX /home/sim/phantom_x/devel)
  ...
  set(phantomx_gazebo_INSTALL_PREFIX /home/sim/phantom_x/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phantomx_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sim/phantom_x/src/phantomx_gazebo/${idir}'.  ${_report}")
    endif()
